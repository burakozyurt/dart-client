...
class CommentResourceApi {
  ...
  ///
  /// 
  Future<CommentDTO> createCommentUsingPOST(CommentDTO commentDTO) async {
    Object postBody = commentDTO;

    // verify required params are set
    if(commentDTO == null) {
     throw new ApiException(400, "Missing required param: commentDTO");
    }

    // create path and map variables
    String path = "/api/comments".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'CommentDTO') as CommentDTO ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future deleteCommentUsingDELETE(int id) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/api/comments/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  ///
  /// 
  Future<List<CommentDTO>> getAllCommentsUsingGET({ int entityIdEquals, int entityIdGreaterThan, int entityIdGreaterThanOrEqual, List<int> entityIdIn, int entityIdLessThan, int entityIdLessThanOrEqual, int entityIdNotEquals, bool entityIdSpecified, String entityNameContains, String entityNameDoesNotContain, String entityNameEquals, List<String> entityNameIn, String entityNameNotEquals, bool entityNameSpecified, int idEquals, int idGreaterThan, int idGreaterThanOrEqual, List<int> idIn, int idLessThan, int idLessThanOrEqual, int idNotEquals, bool idSpecified, int userIdEquals, int userIdGreaterThan, int userIdGreaterThanOrEqual, List<int> userIdIn, int userIdLessThan, int userIdLessThanOrEqual, int userIdNotEquals, bool userIdSpecified }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<CommentDTO>') as List).map((item) => item as CommentDTO).toList();
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<CommentDTO> getCommentUsingGET(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<CommentDTO> updateCommentUsingPUT(CommentDTO commentDTO) async {
    Object postBody = commentDTO;
