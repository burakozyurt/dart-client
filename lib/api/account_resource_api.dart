...
class AccountResourceApi {
  ...
  ///
  /// 
  Future activateAccountUsingGET(String key) async {
  ...
  ///
  /// 
  Future changePasswordUsingPOST(PasswordChangeDTO passwordChangeDto) async {
    Object postBody = passwordChangeDto;

    // verify required params are set
    if(passwordChangeDto == null) {
     throw new ApiException(400, "Missing required param: passwordChangeDto");
    }
  ...
  ///
  /// 
  Future finishPasswordResetUsingPOST(KeyAndPasswordVM keyAndPassword) async {
    Object postBody = keyAndPassword;

    // verify required params are set
    if(keyAndPassword == null) {
     throw new ApiException(400, "Missing required param: keyAndPassword");
    }
  ...
  ///
  /// 
  Future<UserDTO> getAccountUsingGET() async {
    Object postBody = null;
  ...
  ///
  /// 
  Future registerAccountUsingPOST(ManagedUserVM managedUserVM) async {
    Object postBody = managedUserVM;

    // verify required params are set
    if(managedUserVM == null) {
     throw new ApiException(400, "Missing required param: managedUserVM");
    }
  ...
  ///
  /// 
  Future requestPasswordResetUsingPOST(String mail) async {
    Object postBody = mail;

    // verify required params are set
    if(mail == null) {
     throw new ApiException(400, "Missing required param: mail");
    }
  ...
  ///
  /// 
  Future saveAccountUsingPOST(UserDTO userDTO) async {
