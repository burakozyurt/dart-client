...
class LikedResourceApi {
  ...
  ///
  /// 
  Future<LikedDTO> createLikedUsingPOST(LikedDTO likedDTO) async {
    Object postBody = likedDTO;

    // verify required params are set
    if(likedDTO == null) {
     throw new ApiException(400, "Missing required param: likedDTO");
    }

    // create path and map variables
    String path = "/api/likeds".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'LikedDTO') as LikedDTO ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future deleteLikedUsingDELETE(int id) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/api/likeds/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  ///
  /// 
  Future<List<LikedDTO>> getAllLikedsUsingGET({ int entityIdEquals, int entityIdGreaterThan, int entityIdGreaterThanOrEqual, List<int> entityIdIn, int entityIdLessThan, int entityIdLessThanOrEqual, int entityIdNotEquals, bool entityIdSpecified, String entityNameContains, String entityNameDoesNotContain, String entityNameEquals, List<String> entityNameIn, String entityNameNotEquals, bool entityNameSpecified, int idEquals, int idGreaterThan, int idGreaterThanOrEqual, List<int> idIn, int idLessThan, int idLessThanOrEqual, int idNotEquals, bool idSpecified, int userIdEquals, int userIdGreaterThan, int userIdGreaterThanOrEqual, List<int> userIdIn, int userIdLessThan, int userIdLessThanOrEqual, int userIdNotEquals, bool userIdSpecified }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<LikedDTO>') as List).map((item) => item as LikedDTO).toList();
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<LikedDTO> getLikedUsingGET(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<LikedDTO> updateLikedUsingPUT(LikedDTO likedDTO) async {
    Object postBody = likedDTO;
