...
class HairStyleResourceApi {
  ...
  ///
  /// 
  Future<HairStyleDTO> createHairStyleUsingPOST(HairStyleDTO hairStyleDTO) async {
    Object postBody = hairStyleDTO;

    // verify required params are set
    if(hairStyleDTO == null) {
     throw new ApiException(400, "Missing required param: hairStyleDTO");
    }

    // create path and map variables
    String path = "/api/hair-styles".replaceAll("{format}","json");
    ...
    if(response.statusCode >= 400) {
      ...
      return 
          apiClient.deserialize(response.body, 'HairStyleDTO') as HairStyleDTO ;
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future deleteHairStyleUsingDELETE(int id) async {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/api/hair-styles/{id}".replaceAll("{format}","json").replaceAll("{" + "id" + "}", id.toString());
  ...
  ///
  /// 
  Future<List<HairStyleDTO>> getAllHairStylesUsingGET({ String aliasContains, String aliasDoesNotContain, String aliasEquals, List<String> aliasIn, String aliasNotEquals, bool aliasSpecified, int idEquals, int idGreaterThan, int idGreaterThanOrEqual, List<int> idIn, int idLessThan, int idLessThanOrEqual, int idNotEquals, bool idSpecified }) async {
    Object postBody = null;
    ...
    if(response.statusCode >= 400) {
      ...
      return 
        (apiClient.deserialize(response.body, 'List<HairStyleDTO>') as List).map((item) => item as HairStyleDTO).toList();
    } else {
      return null;
    }
  }
  ...
  ///
  /// 
  Future<HairStyleDTO> getHairStyleUsingGET(int id) async {
    Object postBody = null;
  ...
  ///
  /// 
  Future<HairStyleDTO> updateHairStyleUsingPUT(HairStyleDTO hairStyleDTO) async {
    Object postBody = hairStyleDTO;
